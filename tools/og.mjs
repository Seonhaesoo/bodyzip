...
export const OG = [
  ...
  { key: 'checkup2026', title: '올해 건강검진,\n나는 대상일까', sub: '2026년은 짝수년생 · 태어난 해 넣으면 나이별 항목 · 12월 31일까지 · 과태료', kicker: '2026년 국가건강검진' },
  { key: 'flu', title: '올겨울 독감 주사,\n나는 언제 무료일까', sub: '어린이·임신부 9월 21일 · 65세 이상 10월 12일부터 연령별 · 2027년 4월 30일까지', kicker: '2026-2027 독감 예방접종' },
