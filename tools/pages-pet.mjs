...
${ageForm(kind, 5)}
${section('사람 나이로 바꾸는 법', null, kind === 'dog'
  ? `<p>"강아지 1년은 사람의 7년"이라는 공식은 요즘 잘 쓰지 않아요. 강아지는 첫 두 해에 아주 빨리 자라고, 그 뒤로는 몸집에 따라 속도가 달라지기 때문이에요. 통용되는 계산은 <b>첫돌을 사람의 15세, 두 살을 24세</b>로 보고, 세 살부터는 해마다 소형견 4세, 중형견 5세, 대형견 6세씩 더하는 방식입니다. 그래서 같은 10살이라도 소형견은 56세, 대형견은 72세로 차이가 나요.</p>
<p>큰 개일수록 빨리 늙는 이유는 몸집이 클수록 성장 속도가 빠르고 심장과 관절에 부담이 커서라고 봅니다. 소형견은 7~8살, 중형견은 6~7살, 대형견은 5~6살 무렵부터 노령견으로 보고 건강검진 주기를 1년에 두 번으로 늘리는 것이 좋아요. 품종과 건강 상태에 따라 다르니 정확한 판단은 수의사와 상의하세요.</p>`
  : `<p>고양이는 몸집 차이가 크지 않아 강아지보다 계산이 단순해요. 통용되는 계산은 <b>첫돌을 사람의 15세, 두 살을 24세</b>로 보고, 세 살부터는 해마다 4세씩 더하는 방식입니다. 5살이면 36세, 10살이면 56세, 15살이면 76세쯤이에요. 실내에서 지내는 고양이는 바깥 고양이보다 오래 사는 편이라 15살을 넘기는 일도 흔합니다.</p>
<p>고양이는 7살 무렵부터 중년, 11살부터 노령묘로 봅니다. 이 시기부터는 신장·갑상선·치아 문제가 늘어나니 검진 주기를 1년에 두 번으로 늘리고, 물 마시는 양과 몸무게 변화를 살펴 주세요. 품종과 건강 상태에 따라 다르니 정확한 판단은 수의사와 상의하세요.</p>`)}
${section('자주 묻는 질문', null, kind === 'dog'
  ? `<h3>강아지 1살은 사람 나이로 몇 살인가요?</h3><p>약 15세로 봅니다. 첫돌이면 사람의 청소년기에 해당해요. 2살은 24세, 그 뒤로는 크기에 따라 해마다 4~6세씩 더합니다.</p>
<h3>소형견·중형견·대형견은 어떻게 나누나요?</h3><p>보통 다 자란 몸무게로 나눕니다. 10kg 아래를 소형견, 10~25kg을 중형견, 25kg 이상을 대형견으로 보는 기준을 썼어요.</p>
<h3>강아지는 몇 살부터 노령견인가요?</h3><p>소형견 7~8살, 중형견 6~7살, 대형견 5~6살 무렵부터입니다. 사람 나이로 50대에 들어서는 때예요.</p>`
  : `<h3>고양이 1살은 사람 나이로 몇 살인가요?</h3><p>약 15세로 봅니다. 2살은 24세, 그 뒤로는 해마다 4세씩 더해요.</p>
<h3>고양이는 몇 살부터 노령묘인가요?</h3><p>11살 무렵부터 노령묘로 봅니다. 사람 나이로 60세쯤이에요. 7살부터는 중년으로 보고 검진을 챙기기 시작하면 좋아요.</p>
<h3>고양이 20살은 사람 나이로 몇 살인가요?</h3><p>약 96세예요. 20살을 넘기는 고양이도 있지만 드문 편이고, 이때는 반년마다 검진을 권합니다.</p>`)}
