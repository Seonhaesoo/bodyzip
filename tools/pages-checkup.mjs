...
${section('이어서', null, list([{ href: '/checkup/2026/', title: '2026년 건강검진 대상자', sub: '짝수년생 확인 · 나이별 항목 · 과태료' }, { href: '/flu/', title: '2026-2027 독감 예방접종', sub: '무료 대상·시작일' }, { href: '/bmi/', title: 'BMI · 정상 체중', sub: '검진의 시작' }, { href: '/bmr/', title: '기초대사량 · 하루 칼로리', sub: '식사량 기준' }, { href: '/quit-smoking/', title: '금연 계산기', sub: '수치를 되돌리는 가장 빠른 길' }]))}
${NOTE('')}` }));
